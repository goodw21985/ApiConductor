...
class Rewriter(scope_analyzer.ScopeAnalyzer):
    ...
    def visit_Module(self, node):
        ...
        argument=ast.Name(self.functionPrefix+self.concurrency_groups[0].name, ctx=ast.Load())
        ...
        call_program = ast.Call(func = ast.Name(self.programFunction, ctx=ast.Load()),args=[],keywords=[])
