...
def _program():
    ...
    def _concurrent_G0():
        ...
        pass
        q = 3
        _1 = orchestrator.Task(orchestrator.search_email(q, 0))
    ...
    def _concurrent_G1():
        ...
        _2 = sum + 'a'
        _4 = sum2 + 'b'
        _3 = orchestrator.Task(orchestrator.search_meetings(_2))
        orchestrator._add_task(_3, _completion_3)
        _5 = orchestrator.Task(orchestrator.search_teams(b=_4))
